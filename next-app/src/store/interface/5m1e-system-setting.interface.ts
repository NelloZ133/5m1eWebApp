import { Position, UserJoinRolePosition, I5M1ESystemSettingResponse } from "@/types/5m1e-setting.type";
...
export interface I5M1ESystemSettingState {
  ...
  getUserJoinRolePositionByUserId: (userId: string) => UserJoinRolePosition | undefined
  getUserJoinRolePositionByUUID: (uuid: string) => UserJoinRolePosition | undefined
  getUserJoinRolePositionByEmail: (email: string) => UserJoinRolePosition | undefined
}
