...
export const RequestProblemFormSlice: StateCreator<IRequestProblemFormState> = (set, get) => ({
  ...
  availableCategoryItemList() {
    return _5M1ESettingStore.getState().listItemProblemDict?.[get().selectedCategory ?? ''] ?? []
  },
