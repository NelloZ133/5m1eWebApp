import { RequestData, RequestChangeData } from "./request-form.type";
...
export interface I5M1EChangeRequestListResponse {
  action_created_at: string;
  action_id: number;
  action_updated_at: string;
  current_state_id: number;
  ...
  request_change_no: string | null;
  request_data_id: number;
  request_data_value: RequestChangeData;
  request_id: string;
  request_problem_no: string | null;
  request_process_id: number;
  transition_id: number;
...
export type _5M1EChangeRequest = {
  action_id: number;
  current_state_id: number;
  data_created_at: string;
  data_updated_at: string;
