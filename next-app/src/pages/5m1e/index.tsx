...
const _5M1E: NextPage = () => {
  const { fetchSetting, canCreateProblemRequest, canCreateChangePointRequest } = _5M1ESettingStore()
      ...
      <Layout
        ...
        <div className="w-full h-full flex flex-col justify-center">
          <div className="link-group animate__animated animate__fadeIn text-2xl text-center">
            ...
            { canCreateProblemRequest() ? <Link href={"/5m1e/report/problem"}>
              <p>Report - Problem</p>
            </Link> : null}
            { canCreateChangePointRequest() ? <div onClick={() => setSelectRequestModal(true)}>
